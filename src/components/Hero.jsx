  ...
  return (
    <div className='text-white flex -z-10 mt-[-50px]'>
      <div className='max-w-[800px] mt-[-120px]  h-screen mx-auto text-left flex inline-flex flex-col justify-center'>
        <p className='text-[#FDC435] font-bold p-2 text-1xl font-PlayfairDisplay'>
          FRONT-END DEVELOPER
        </p>
        <h1 className=' text-[black] md:text-7xl sm:text-6xl text-4xl font-bold md:py-6 font-PlayfairDisplay'>
          Hi, my name is <br/> Mohsan Farid 
        </h1>
        <div className='flex justify-center items-center text-[black]'>
          <p className='md:text-5xl sm:text-4xl text-xl font-bold py-4 font-PlayfairDisplay'>
            I specialize in
          </p>
          <Typed
            className='md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2 text-[#FDC435] font-PlayfairDisplay'
